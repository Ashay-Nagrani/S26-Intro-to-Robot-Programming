...
class TurtleClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('turtleColor', 'red', ParameterDescriptor(description='Initial turtle color'))
        self.declare_parameter('penSize', 2, ParameterDescriptor(description='Initial pen size'))
